...
def create_tracker_from_action(
    ...
    create_review_tracker(
        user_id,
        {
            ...
            "aspect_key": payload.aspect_key or action.get("aspect_key"),
            "canonical_issue_key": payload.canonical_issue_key or action.get("canonical_issue_key"),
            "specific_issue": payload.specific_issue or action.get("specific_issue") or action.get("tag_name"),
