# Annotate Prompt v2.3

> Created: 2026-06-08
> Replaces: v2.2 (which over-corrected toward negative on 3-star reviews)
> Model: deepseek-chat (DeepSeek-V4-flash)
> Format: System prompt + JSON mode + 12 few-shot examples
> Changes from v2.2:
>   - REWRITTEN 3-star rule (1.3): the decisive signal is the user's OVERALL stance on the CORE PRODUCT, not the count of complaints
>   - "Otherwise solid / Good but / Bed is fine / Correct" + single complaint → NEUTRAL (core OK, isolated issue)
>   - "It's mediocre / Just OK / Very disappointed" + complaint → NEGATIVE (overall dissatisfaction)
>   - NEW: Example 8 改为更精确的 3-star negative ("It's mediocre" + 多缺陷 + 无核心肯定)
>   - NEW: Example 9 改为更精确的 3-star negative ("Very disappointed" 强烈措辞)
>   - NEW: Example 12 — 3-star "Otherwise solid" / "Bed is fine" + single complaint → NEUTRAL
> Changes from v2.1:
>   - Stricter rating ≤ 2 → negative (modes B retained)
>   - 3-star rule rewritten with clearer recognition of "core-product-OK + single-issue" pattern
